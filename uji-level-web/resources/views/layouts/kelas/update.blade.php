                        ...
                        <form method="POST" action="{{ route('kelas.store') }}">
                            ...
                            <div class="mt-3">
                                ...
                                <input id="regular-form-1" type="text" name="nama" class="form-control"
                                    placeholder="Masukkan Nama Kelas" value="{{$kelas->nama}}">
                            </div>
                            <div class="mt-3">
                                ...
                                <option value="{{ $walas->id }}" @if($walas->id == $kelas->walas_id) selected @endif>{{ $walas->nama }}</option>
                            @endforeach
                                </select>
                            </div>
                            <div class="mt-3">
                                ...
                                <select name="guru_id" class="tom-select mb-3">
                                    ...
                                    <option value="{{ $guru->id }}" @if($guru->id == $kelas->guru_id) selected @endif>{{ $guru->nama }}</option>
                                @endforeach 
                                </select>
                            </div>
