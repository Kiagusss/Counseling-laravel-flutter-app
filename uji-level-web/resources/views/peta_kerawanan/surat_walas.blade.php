...
<body>
    ...
    <div class="content">
        ...
        <p>Sehubungan dengan adanya sesuatu yang perlu disampaikan kepada Bapak/Ibu,Maka kami mengundang Bapak/Ibuk untuk hadir ke ruangan saya {{ $siswa->kelasid->walas->nama }} Besok seusai pulang sekolah</p>
        ...
        <p>Salam,</p>
        <p> Wali Kelas {{ $siswa->kelasid->nama }}</p>
    </div>

    <div class="footer">
        Tanda tangan <br><br><br><br><br>{{ $siswa->kelasid->walas->nama }}
    </div>
</body>
