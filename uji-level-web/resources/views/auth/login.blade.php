{{-- <x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                <x-label for="email" value="{{ __('Email/Nipd/Nisn') }}" />
                <x-input id="email" class="block mt-1 w-full" type="text" name="login" :value="old('login')" required autofocus autocomplete="username" />
            </div>
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                @endif
                        ...
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block" name="login" :value="old('login')" required autofocus  placeholder="Email/Nisn/Nipd">
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" type="password" name="password" required autocomplete="current-password" >
                        </div>
