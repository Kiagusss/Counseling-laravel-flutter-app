...
<body>
    ...
    <div class="containers pt-28">
                ...
                <div class="udin w-full h-full flex pl-[150px] pr-[150px]">
                    ...
                    <div class="left w-[550px] h-full " style="">
                        <div class="gambar overflow-hidden	 w-[80%] h-[75%] rounded-[20px] mt-[8%] ml-[10%]"
                            ...
                            <img src="{{ asset('image/vintage library.jpeg')}}" class="" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="left w-[700px] h-full" style="">
                        <div class="ml-[10px] w-[600px] h-[380px] shadow-md" style="background-color: white">
                            ...
                            <div class="w-[90%] h-[100px] ml-[30px] mt-[10px]" style="">
                                ...
                                <p class="mt-[5px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga culpa sit adipisci aliquid veniam magnam praesentium? Nisi nostrum atque ad!</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="teach w-full h-[1150px]" style="background-color: white">
            ...
            <div class="foto flex mt-[100px] ml-[70px] w-[90%] h-[400px] justify-around" style="">
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/bu caca.png') }}" alt="" srcset="">
                    </div>
                ...
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/pa gun.png') }}" alt="" srcset="">
                    </div>
                ...
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/bu heni.jpg') }}" alt="" srcset="">
                    </div>
                    <p class="mt-[10px] w-full text-center text-[15px]">Tenaga Pendidik Bimbingan Konseling</p>
            ...
            <div class="foto flex mt-[50px] ml-[70px] w-[90%] h-[400px] justify-around" style="">
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/bu fika.png') }}" alt="" srcset="">
                    </div>
                    <p class="mt-[10px] w-full text-center text-[15px]">Tenaga Pendidik Bimbingan Konseling</p>
                ...
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/bu shei.png') }}" alt="" srcset="">
                    </div>
                    <p class="mt-[10px] w-full text-center text-[15px]">Tenaga Pendidik Bimbingan Konseling</p>
                ...
                <div class="guru w-[20%] h-full" style="">
                    <div class="guru w-[70%] h-[70%] ml-[40px] overflow-hidden " style="">
                        <img src="{{ asset('image/bu nad.png') }}" alt="" srcset="">
                    </div>
                    <p class="mt-[10px] w-full text-center text-[15px]">Tenaga Pendidik Bimbingan Konseling</p>
